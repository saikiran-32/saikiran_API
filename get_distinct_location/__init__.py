...
def main(req: func.HttpRequest) -> func.HttpResponse:
    logging.info('Distinct locaiton type HTTP trigger function processed a request.')
    ...
    query = 'SELECT distinct upper(c.location) FROM c order by c.location asc'
    
    distinct_location = list(
